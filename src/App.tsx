...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F2EB] text-[#141210] flex flex-col font-tiro selection:bg-[#141210] selection:text-[#F5F2EB]">
      ...
      {/* Authentic Broadsheet Editorial Footer */}
